...
public class LarPager<T> implements Serializable {
	...
	protected Map<String, Object> extendMap = new HashMap<String, Object>();
	protected List<Object> extendList=new ArrayList<Object>();
	 ...
	 */
	public LarPager<T> pageNo(final int thePageNo) {
		setPageNo(thePageNo);
		return this;
	}
	 ...
	 */
	public LarPager<T> pageSize(final int thePageSize) {
	 ...
	 */
	public LarPager<T> orderBy(final String theOrderBy) {
	...
	public void setOrder(final String order) {
		if(order!=null&&orderBy!=null&&!"".equals(order)&&!"".equals(orderBy)){
	 ...
	 */
	public LarPager<T> order(final String theOrder) {
		setOrder(theOrder);
		return this;
	}
	 ...
	 */
	public LarPager<T> autoCount(final boolean theAutoCount) {
	...
	/**
	 * @param extendMap the extendMap to set
	 */
